...
.method public constructor <init>()V
    ...
    iget-object v1, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->F:Lkgh;

    invoke-direct {v0, p0, v1}, Ljfz;-><init>(Landroid/app/Activity;Lkfc;)V

    iget-object v1, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->E:Lkbv;
    ...
    iput-object v0, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->n:Ljff;
    ...
    invoke-direct {v0, p0}, Lesd;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;)V
    ...
    invoke-direct {v0, p0}, Lerz;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;)V
...
.method private a(Landroid/net/Uri;ILait;ZLjava/util/List;)Z
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p2}, Laiy;-><init>(I)V

    .line 557
    invoke-virtual {v1, p3}, Laiu;->a(Lait;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Laji; {:try_start_0 .. :try_end_0} :catch_4
    .catch Lajf; {:try_start_0 .. :try_end_0} :catch_6

    .line 560
    :try_start_1
    invoke-virtual {v1, v3}, Laiu;->a(Ljava/io/InputStream;)V
    :try_end_1
    ...
    .catch Laji; {:try_start_2 .. :try_end_2} :catch_4
    .catch Lajf; {:try_start_2 .. :try_end_2} :catch_6
    ...
    .catch Laji; {:try_start_3 .. :try_end_3} :catch_4
    .catch Lajf; {:try_start_3 .. :try_end_3} :catch_6
    ...
    invoke-direct {v1, p2}, Laiz;-><init>(I)V
    ...
    invoke-virtual {v1, v3}, Laiu;->a(Ljava/io/InputStream;)V
    :try_end_6
    .catch Lajj; {:try_start_6 .. :try_end_6} :catch_7
    ...
    .catch Laji; {:try_start_7 .. :try_end_7} :catch_4
    .catch Lajf; {:try_start_7 .. :try_end_7} :catch_6
    ...
    .catch Laji; {:try_start_8 .. :try_end_8} :catch_4
    .catch Lajf; {:try_start_8 .. :try_end_8} :catch_6
    ...
    .catch Laji; {:try_start_a .. :try_end_a} :catch_4
    .catch Lajf; {:try_start_a .. :try_end_a} :catch_6
    ...
    .catch Laji; {:try_start_b .. :try_end_b} :catch_4
    .catch Lajf; {:try_start_b .. :try_end_b} :catch_6
    ...
    invoke-direct {v1, v4}, Lajf;-><init>(Ljava/lang/String;)V
    ...
    .catch Laji; {:try_start_d .. :try_end_d} :catch_4
    .catch Lajf; {:try_start_d .. :try_end_d} :catch_6
...
.method public static synthetic a(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;Landroid/net/Uri;ILait;ZLjava/util/List;)Z
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->a(Landroid/net/Uri;ILait;ZLjava/util/List;)Z
...
# virtual methods
.method public a(Lahx;Ljava/util/List;Ljava/util/List;)V
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v1, v3, v0}, Lja;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 3618
    iget-object v0, p1, Lahx;->a:Ljava/util/List;
    ...
    invoke-virtual {v0}, Laik;->b()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Laik;->d()Ljava/lang/String;
    ...
    invoke-virtual {v1, v5, v6}, Lja;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v5, v0}, Lja;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 3622
    :cond_4
    iget-object v0, p1, Lahx;->b:Ljava/util/List;
    ...
    invoke-virtual {v0}, Laib;->d()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Laim;->h()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Laim;->j()Ljava/lang/String;
    ...
    .line 229
    :cond_b
    invoke-virtual {v0}, Laim;->e()Ljava/lang/String;
    ...
    .line 233
    :cond_c
    invoke-virtual {v0}, Laim;->f()Ljava/lang/String;
    ...
    .line 237
    :cond_d
    invoke-virtual {v0}, Laim;->g()Ljava/lang/String;
    ...
    invoke-virtual {v1, v6, v5}, Lja;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 3634
    :cond_12
    iget-object v0, p1, Lahx;->e:Ljava/util/List;
    ...
    invoke-virtual {v0}, Laif;->b()Ljava/lang/String;
    ...
    .line 4630
    :cond_14
    iget-object v0, p1, Lahx;->d:Ljava/util/List;
    ...
    invoke-virtual {v0}, Laij;->c()Ljava/lang/String;
    ...
    .line 289
    invoke-virtual {v0}, Laij;->d()Ljava/lang/String;
    ...
    .line 290
    invoke-virtual {v5, v6, v1}, Lja;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v5, v1, v0}, Lja;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 4642
    :cond_17
    iget-object v0, p1, Lahx;->f:Ljava/util/List;
    ...
    invoke-virtual {v1, v0, v2}, Lja;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 6614
    :cond_1a
    iget-object v0, p1, Lahx;->g:Ljava/util/List;
    ...
    invoke-virtual {v2, v0, v4}, Lja;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public a(Landroid/net/Uri;Lajb;)V
    .locals 6
    ...
    invoke-static {v0}, Lahw;->a(Ljava/lang/String;)I
    ...
    invoke-direct {v3, v2, v1}, Laiq;-><init>(ILandroid/accounts/Account;)V
    ...
    invoke-direct {v0, p0, v1}, Lais;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;Landroid/os/Handler;)V

    invoke-virtual {v3, v0}, Laiq;->a(Lais;)V
...
.method public c(I)Landroid/net/Uri;
    ...
    .line 441
    sget-object v0, Lddo;->bF:Ljava/util/Random;
    ...
    invoke-static {v3, v4, v0}, Lgmw;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {v2, p0, v0}, Lesb;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;Landroid/net/Uri;)V
    ...
    .line 130
    :goto_1
    invoke-virtual {p0}, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->g()Lrl;

    move-result-object v0

    .line 131
    invoke-virtual {v0, v4}, Lrl;->b(Z)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    iget-object v0, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->n:Ljff;
    ...
    invoke-direct {v0, p0}, Lesa;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;)V
    ...
    .line 7431
    invoke-virtual {v0, v1}, Lesa;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
