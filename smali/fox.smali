...
.method public constructor <init>(Lcom/google/android/apps/hangouts/realtimechat/wakelock/impl/DebugWakelocksActivity;Landroid/content/Context;)V
    ...
    invoke-virtual {p0, v0}, Lfox;->setOrientation(I)V

    .line 61
    new-instance v0, Lfoy;

    iget-object v1, p0, Lfox;->a:Lcom/google/android/apps/hangouts/realtimechat/wakelock/impl/DebugWakelocksActivity;

    invoke-direct {v0, v1}, Lfoy;-><init>(Landroid/content/Context;)V

    invoke-virtual {p0, v0}, Lfox;->addView(Landroid/view/View;)V
