...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lhbl;->b:Landroid/content/Context;

    return-void
.end method

.method static declared-synchronized a(Landroid/content/Context;)Lhbl;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lhbl;-><init>(Landroid/content/Context;)V
...
.method private b(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-static {p1, v0}, Lhbl;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lhbl;->b:Landroid/content/Context;
    ...
    invoke-static {v0}, Lhau;->b(Landroid/os/Bundle;)V
    ...
    :cond_2
    iget-object v0, p0, Lhbl;->b:Landroid/content/Context;
...
.method private b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lhbl;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lhbl;->b:Landroid/content/Context;
    ...
    :goto_2
    invoke-static {v0}, Lhbl;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method a(Landroid/os/Bundle;)Z
    ...
    invoke-direct {p0, p1, v0}, Lhbl;->b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v7, p0, Lhbl;->b:Landroid/content/Context;
    ...
    .line 1000
    :goto_1
    invoke-direct {p0, p1}, Lhbl;->b(Landroid/os/Bundle;)Landroid/app/PendingIntent;

    move-result-object v7

    new-instance v8, Ldu;

    iget-object v9, p0, Lhbl;->b:Landroid/content/Context;

    invoke-direct {v8, v9}, Ldu;-><init>(Landroid/content/Context;)V

    const/4 v9, 0x1

    invoke-virtual {v8, v9}, Ldu;->e(Z)Ldu;

    move-result-object v8

    invoke-virtual {v8, v3}, Ldu;->a(I)Ldu;
    ...
    invoke-virtual {v3, v4}, Ldu;->a(Ljava/lang/CharSequence;)Ldu;
    ...
    invoke-virtual {v3, v5}, Ldu;->b(Ljava/lang/CharSequence;)Ldu;
    ...
    invoke-virtual {v3, v4}, Ldu;->e(I)Ldu;

    :cond_1
    if-eqz v0, :cond_2

    invoke-virtual {v3, v0}, Ldu;->a(Landroid/net/Uri;)Ldu;

    :cond_2
    if-eqz v7, :cond_3

    invoke-virtual {v3, v7}, Ldu;->a(Landroid/app/PendingIntent;)Ldu;

    :cond_3
    invoke-virtual {v3}, Ldu;->b()Landroid/app/Notification;
    ...
    iget-object v8, p0, Lhbl;->b:Landroid/content/Context;
    ...
    invoke-virtual {v3, v4}, Ldu;->a(Ljava/lang/CharSequence;)Ldu;
    :try_end_0
    .catch Lhbm; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v0}, Lhbm;->getMessage()Ljava/lang/String;
