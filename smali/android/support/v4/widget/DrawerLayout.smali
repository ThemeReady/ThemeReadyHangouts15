...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->c:Lqd;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Lqc;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->e:Lqc;
    ...
    invoke-direct {v2, p0, v3}, Lqk;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lqk;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->n:Lqk;

    .line 383
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lqk;

    invoke-static {p0, v5, v2}, Lrh;->a(Landroid/view/ViewGroup;FLrk;)Lrh;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lrh;

    .line 384
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lrh;

    invoke-virtual {v2, v4}, Lrh;->a(I)V

    .line 385
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lrh;

    invoke-virtual {v2, v1}, Lrh;->a(F)V

    .line 386
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lqk;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lrh;

    invoke-virtual {v2, v3}, Lqk;->a(Lrh;)V

    .line 388
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->n:Lqk;

    invoke-static {p0, v5, v2}, Lrh;->a(Landroid/view/ViewGroup;FLrk;)Lrh;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lrh;

    .line 389
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lrh;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Lrh;->a(I)V
    ...
    .line 391
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->n:Lqk;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lrh;

    invoke-virtual {v1, v2}, Lqk;->a(Lrh;)V
    ...
    invoke-direct {v1, p0}, Lqb;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    invoke-static {p0, v1}, Lmc;->a(Landroid/view/View;Ljv;)V
    ...
    invoke-virtual {v1, p0, v2}, Lmu;->a(Landroid/view/ViewGroup;Z)V

    .line 401
    invoke-static {p0}, Lmc;->n(Landroid/view/View;)Z
    ...
    .line 402
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->c:Lqd;

    invoke-interface {v1, p0}, Lqd;->a(Landroid/view/View;)V

    .line 403
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->c:Lqd;

    invoke-interface {v1, p1}, Lqd;->a(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method private static a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    invoke-static {p0}, Lgx;->b(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 1174
    :cond_1
    invoke-static {p0, p1}, Lgx;->b(Landroid/graphics/drawable/Drawable;I)Z
...
.method private c(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Lmc;->c(Landroid/view/View;I)V
...
.method public a(II)V
    ...
    .line 618
    invoke-static {p2, v0}, Lkl;->a(II)I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lrh;
    ...
    .line 638
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lrh;
...
.method public a(ILandroid/view/View;)V
    ...
    invoke-virtual {v2}, Lrh;->a()I

    move-result v2

    .line 804
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lrh;

    invoke-virtual {v3}, Lrh;->a()I
    ...
    invoke-virtual {v0, v2}, Lqg;->a(I)V
...
.method a(Landroid/view/View;F)V
    ...
    invoke-virtual {v0, p1, p2}, Lqg;->a(Landroid/view/View;F)V
...
.method public a(Landroid/view/View;Z)V
    ...
    invoke-virtual {v0, p1, v2, v1}, Lrh;->a(Landroid/view/View;II)Z
    ...
    .line 1619
    invoke-virtual {v0, p1, v1, v2}, Lrh;->a(Landroid/view/View;II)Z
...
.method public a(Lqg;)V
    ...
    .prologue
    .line 535
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->x:Lqg;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/DrawerLayout;->c(Lqg;)V
    ...
    .line 539
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/DrawerLayout;->b(Lqg;)V

    .line 543
    :cond_1
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->x:Lqg;
...
.method a(Z)V
    ...
    .line 1569
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lrh;
    ...
    .line 1569
    invoke-virtual {v7, v5, v6, v8}, Lrh;->a(Landroid/view/View;II)Z
    ...
    .line 1572
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lrh;
    ...
    .line 1572
    invoke-virtual {v6, v5, v7, v8}, Lrh;->a(Landroid/view/View;II)Z
    ...
    .line 1579
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lqk;

    invoke-virtual {v0}, Lqk;->a()V

    .line 1580
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->n:Lqk;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Lmc;->c(Landroid/view/View;I)V
    ...
    .line 1990
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->e:Lqc;

    invoke-static {p1, v0}, Lmc;->a(Landroid/view/View;Ljv;)V
...
.method c(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Lqg;->a(Landroid/view/View;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v4}, Lrh;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lrh;

    invoke-virtual {v1, v4}, Lrh;->a(Z)Z
...
.method public g(Landroid/view/View;)Z
    ...
    .line 1423
    invoke-static {p1}, Lmc;->d(Landroid/view/View;)I

    move-result v2

    .line 1422
    invoke-static {v0, v2}, Lkl;->a(II)I
...
.method protected generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, v1}, Lqh;-><init>(II)V
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Lqh;-><init>(Lqh;)V
    ...
    invoke-direct {v0, p1}, Lqh;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1344
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->c:Lqd;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->G:Ljava/lang/Object;

    invoke-interface {v0, v1}, Lqd;->a(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v3, p1}, Lrh;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lrh;

    .line 1441
    invoke-virtual {v4, p1}, Lrh;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 1452
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lrh;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Lrh;->b(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Lrh;->c(I)Z
...
.method protected onLayout(ZIIII)V
    ...
    .line 1193
    iget v1, v0, Lqh;->leftMargin:I

    iget v2, v0, Lqh;->topMargin:I
    ...
    .line 1217
    iget v4, v0, Lqh;->topMargin:I

    add-int/2addr v9, v2

    iget v11, v0, Lqh;->topMargin:I
    ...
    .line 1224
    iget v10, v0, Lqh;->bottomMargin:I
    ...
    iget v11, v0, Lqh;->bottomMargin:I
    ...
    iget v13, v0, Lqh;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v6, v8}, Lkl;->a(II)I

    move-result v6

    .line 1068
    invoke-static {v10}, Lmc;->n(Landroid/view/View;)Z
    ...
    .line 1069
    sget-object v11, Landroid/support/v4/widget/DrawerLayout;->c:Lqd;

    iget-object v12, p0, Landroid/support/v4/widget/DrawerLayout;->G:Ljava/lang/Object;

    invoke-interface {v11, v10, v12, v6}, Lqd;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    .line 1077
    iget v6, v0, Lqh;->leftMargin:I

    sub-int v6, v2, v6

    iget v11, v0, Lqh;->rightMargin:I
    ...
    invoke-interface {v11, v0, v12, v6}, Lqd;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    .line 3913
    sget-object v6, Lmc;->a:Lml;

    invoke-virtual {v6, v10}, Lml;->B(Landroid/view/View;)F
    ...
    invoke-static {v10, v6}, Lmc;->f(Landroid/view/View;F)V
    ...
    iget v12, v0, Lqh;->bottomMargin:I

    add-int/2addr v11, v12

    iget v0, v0, Lqh;->height:I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v6, v0}, Lqi;-><init>(Landroid/os/Parcelable;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Lrh;->b(Landroid/view/MotionEvent;)V
    ...
    .line 1505
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lrh;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Lrh;->b(II)Landroid/view/View;
