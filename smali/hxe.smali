...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhxe;->o:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lhxd;ZILandroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-direct/range {p0 .. p7}, Lhwz;-><init>(Landroid/content/Context;Lhxd;ZILandroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)V
...
.method private e()Ljava/lang/String;
    ...
    sget-object v2, Lhxe;->o:[Ljava/lang/String;

    invoke-direct {p0}, Lhxe;->f()Ljava/lang/String;
...
.method private f()Ljava/lang/String;
    ...
    invoke-static {v0}, Lact;->a(Z)V

    invoke-virtual {p0}, Lhxe;->a()Lcom/google/android/gms/common/data/DataHolder;

    move-result-object v0

    invoke-static {v0}, Lact;->N(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v2, v0}, Lhxc;-><init>(Lcom/google/android/gms/common/data/DataHolder;)V

    const/4 v0, 0x1

    :goto_0
    invoke-virtual {v2}, Lhxc;->c()Z
    ...
    invoke-virtual {v2, v3}, Lhxc;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method protected a(Lhxc;Lhxc;Landroid/database/Cursor;)Lhwr;
    ...
    iget-object v1, p0, Lhxe;->i:Lhyr;

    const-string v2, "people-map start"

    invoke-virtual {v1, v2}, Lhyr;->a(Ljava/lang/String;)V

    invoke-static {p1, v4}, Lhxe;->a(Lhxc;Ljava/util/HashMap;)V
    ...
    new-instance v9, Lhyt;

    invoke-direct {v9}, Lhyt;-><init>()V

    new-instance v10, Lhxs;

    invoke-direct {v10}, Lhxs;-><init>()V

    new-instance v8, Ljava/util/HashMap;

    invoke-direct {v8}, Ljava/util/HashMap;-><init>()V

    invoke-virtual {p0, p2, v8}, Lhxe;->b(Lhxc;Ljava/util/HashMap;)V
    ...
    invoke-virtual {p0, p3, v9, v10, v8}, Lhxe;->a(Landroid/database/Cursor;Lhyt;Lhxs;Ljava/util/HashMap;)I

    move-result v1

    iget-object v2, p0, Lhxe;->i:Lhyr;

    const-string v3, "contact-map finish"

    invoke-virtual {v2, v3}, Lhyr;->a(Ljava/lang/String;)V
    ...
    invoke-static {v2, v0}, Lact;->i(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    iget-object v0, p0, Lhxe;->i:Lhyr;
    ...
    invoke-virtual {p0, v2, v1}, Lhxe;->a(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {p1, v2}, Lhxc;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v5, v1}, Lhxt;->a(I)V

    invoke-virtual {v7, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    if-eqz v2, :cond_3

    invoke-virtual {v9, v2}, Lhyt;->a(Ljava/lang/String;)I
    ...
    invoke-virtual {v10, v1}, Lhxs;->a(I)I
    ...
    invoke-virtual {v6, v1}, Lhxt;->a(I)V
    ...
    :cond_c
    invoke-virtual {v6, v9, v2}, Lhxt;->a(Lhyt;Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v1, v0}, Lhxs;->a(II)Ljava/lang/String;
    ...
    iget-object v3, p0, Lhxe;->a:Landroid/content/Context;
    ...
    iget-object v10, p0, Lhxe;->f:Landroid/os/Bundle;
...
.method protected c()Landroid/database/Cursor;
    ...
    invoke-direct {p0}, Lhxe;->e()Ljava/lang/String;
    ...
    invoke-virtual {v3, v2}, Lhyq;->b(Ljava/lang/String;)V
    ...
    invoke-static {v3, v0, v1}, Lhww;->a(Lhyq;ZLandroid/content/Context;)V

    invoke-static {v3}, Lhww;->a(Lhyq;)V
