...
.field private f:Lpbo;

.field private final g:Lpbf;
...
# direct methods
.method public constructor <init>(Lpbm;Landroid/content/Context;Lpbn;)V
    .locals 4
    ...
    .line 626
    iput-object p1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a:Lpbm;
    ...
    invoke-direct {v0, p2}, Lpbe;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->b:Lpbe;

    .line 629
    new-instance v0, Lpbo;

    invoke-direct {v0, p2}, Lpbo;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->f:Lpbo;
    ...
    .line 1350
    invoke-direct {v0, p0}, Lpbf;-><init>(Lorg/chromium/net/NetworkChangeNotifierAutoDetect;)V

    .line 631
    iput-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->g:Lpbf;
    ...
    .line 641
    :goto_0
    invoke-virtual {p0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->d()Lpbl;

    move-result-object v0

    .line 642
    invoke-static {v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a(Lpbl;)I
    ...
    .line 643
    invoke-virtual {v0}, Lpbl;->d()Ljava/lang/String;
    ...
    .line 644
    invoke-virtual {p0, v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->c(Lpbl;)D
    ...
    .line 649
    iput-object p3, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->e:Lpbn;

    .line 650
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->e:Lpbn;

    invoke-virtual {v0, p0}, Lpbn;->a(Lorg/chromium/net/NetworkChangeNotifierAutoDetect;)V
    ...
    .line 638
    :cond_0
    iput-object v3, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->g:Lpbf;
...
.method public static a(Lpbl;)I
    .locals 2

    .prologue
    .line 818
    invoke-virtual {p0}, Lpbl;->a()Z
    ...
    :cond_0
    invoke-virtual {p0}, Lpbl;->b()I

    move-result v0

    invoke-virtual {p0}, Lpbl;->c()I
...
.method public static a(Lpbe;Landroid/net/Network;)[Landroid/net/Network;
    .locals 8
    ...
    .line 750
    invoke-virtual {p0}, Lpbe;->a()[Landroid/net/Network;
    ...
    .line 757
    invoke-virtual {p0, v6}, Lpbe;->c(Landroid/net/Network;)Landroid/net/NetworkCapabilities;
    ...
    .line 764
    invoke-static {v6}, Lpbe;->b(Landroid/net/Network;)Z
...
.method private d(Lpbl;)V
    .locals 3

    .prologue
    .line 950
    invoke-static {p1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a(Lpbl;)I

    move-result v0

    .line 951
    invoke-virtual {p1}, Lpbl;->d()Ljava/lang/String;
    ...
    .line 957
    iget-object v1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a:Lpbm;

    invoke-virtual {v1, v0}, Lpbm;->a(I)V

    goto :goto_0
.end method

.method private e(Lpbl;)V
    .locals 4

    .prologue
    .line 961
    invoke-virtual {p0, p1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->c(Lpbl;)D
    ...
    .line 968
    iget-object v2, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a:Lpbm;

    invoke-virtual {v2, v0, v1}, Lpbm;->a(D)V
...
.method public b()V
    ...
    .line 695
    invoke-direct {p0, v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->d(Lpbl;)V

    .line 696
    invoke-direct {p0, v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->e(Lpbl;)V
    ...
    .line 705
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->g:Lpbf;
    ...
    .line 707
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->b:Lpbe;

    iget-object v1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->h:Landroid/net/NetworkRequest;

    iget-object v3, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->g:Lpbf;

    invoke-virtual {v0, v1, v3}, Lpbe;->a(Landroid/net/NetworkRequest;Landroid/net/ConnectivityManager$NetworkCallback;)V
    ...
    invoke-static {v0, v1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a(Lpbe;Landroid/net/Network;)[Landroid/net/Network;
    ...
    .line 721
    :cond_4
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a:Lpbm;
...
.method public c(Lpbl;)D
    .locals 2

    .prologue
    .line 930
    invoke-static {p1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->b(Lpbl;)I
...
.method public c()V
    ...
    iget-object v1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->g:Lpbf;

    invoke-virtual {v0, v1}, Lpbe;->a(Landroid/net/ConnectivityManager$NetworkCallback;)V

    goto :goto_0
.end method

.method public d()Lpbl;
    .locals 2
    ...
    iget-object v1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->f:Lpbo;

    invoke-virtual {v0, v1}, Lpbe;->a(Lpbo;)Lpbl;
...
.method public e()[J
    ...
    invoke-static {v0, v2}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a(Lpbe;Landroid/net/Network;)[Landroid/net/Network;
    ...
    iget-object v7, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->b:Lpbe;

    invoke-virtual {v7, v5}, Lpbe;->a(Landroid/net/Network;)I
