...
# virtual methods
.method public a(Looa;Lopy;)Ljava/net/URI;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 115
    invoke-virtual {p1}, Looa;->a()Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lopy;->b()Ljava/lang/String;
    ...
    .line 132
    invoke-static {v0}, Loqw;->b(Ljava/net/URI;)Ljava/net/URI;
...
.method public a(Ljava/net/URI;)Ljava/util/Map;
    ...
    .line 150
    :try_start_0
    iget-object v0, p0, Loqw;->c:Llnw;

    invoke-virtual {v0}, Llnw;->b()Ljava/util/Map;
    :try_end_0
...
.method public a(Lopy;Lonz;Looa;)Loob;
    ...
    invoke-direct {v0, p0, v1, p3, p1}, Loog;-><init>(Loqw;Loob;Looa;Lopy;)V
