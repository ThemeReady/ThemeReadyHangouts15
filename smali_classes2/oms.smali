...
.method public static a(Ljava/io/InputStream;Ljava/lang/Integer;Ljava/lang/Integer;ZZZF)Lomq;
    .locals 9
    ...
    .line 329
    new-instance v4, Lomz;

    .line 2140
    invoke-direct {v4, v3}, Lomz;-><init>(Landroid/graphics/Picture;)V

    .line 330
    invoke-virtual {v4, p1, p2}, Lomz;->a(Ljava/lang/Integer;Ljava/lang/Integer;)V

    .line 331
    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Lomz;->a(Z)V

    .line 332
    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Lomz;->b(Z)V

    .line 333
    invoke-virtual {v4, p6}, Lomz;->a(F)V

    .line 338
    new-instance v5, Lomt;

    invoke-direct {v5, p0}, Lomt;-><init>(Ljava/io/InputStream;)V

    .line 340
    new-instance v6, Lomv;

    .line 3073
    invoke-direct {v6}, Lomv;-><init>()V
    ...
    invoke-virtual {v5}, Lomt;->a()Ljava/io/ByteArrayInputStream;
    ...
    .line 344
    iget-object v6, v6, Lomv;->a:Ljava/util/HashMap;

    iput-object v6, v4, Lomz;->a:Ljava/util/HashMap;
    ...
    iget-object v1, v4, Lomz;->o:Landroid/graphics/RectF;

    invoke-direct {v0, v3, v1}, Lomq;-><init>(Landroid/graphics/Picture;Landroid/graphics/RectF;)V

    .line 352
    iget-object v1, v4, Lomz;->p:Landroid/graphics/RectF;
    ...
    invoke-virtual {v0, v1}, Lomq;->a(Landroid/graphics/RectF;)V
    :try_end_0
    ...
    invoke-direct {v1, v0}, Lbq;-><init>(Ljava/lang/Throwable;)V

    throw v1
.end method

.method static a(Ljava/lang/String;)Lomx;
    .locals 10
    ...
    invoke-direct {v0, v6, v4}, Lomx;-><init>(Ljava/util/ArrayList;I)V
    ...
    invoke-direct {v0, v6, v3}, Lomx;-><init>(Ljava/util/ArrayList;I)V
...
.method static a(Ljava/lang/String;Lorg/xml/sax/Attributes;)Lomx;
    .locals 3
...
.method static b(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    invoke-direct {v0, v1, v4}, Lomp;-><init>(Ljava/lang/CharSequence;I)V

    .line 572
    invoke-virtual/range {v28 .. v28}, Lomp;->a()V
    ...
    .line 586
    invoke-virtual/range {v28 .. v28}, Lomp;->b()V
    ...
    .line 601
    :sswitch_0
    invoke-virtual/range {v28 .. v28}, Lomp;->c()F
